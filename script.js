...
// All automobiles manufactured should have the following properties: make (Mazda), location (USA), airbags (true), abs (true), warranty (60,000 miles / 3 years)
...
class FACTORY {
    constructor(warranty = '60,000 miles / 3 years') {
        this.make = 'Mazda';
        this.location = 'USA';
        this.airbags = true;
        this.abs = true;
    ...
    customerBuild(color, options, OPTIONS = []) {
        let trim = options.trim;
        let model = options.model;
...
const Car = new CAR('Mazda3', 4, 'Red', 'hybrid', 'automatic', 'Touring', 'base', 'premium', 'leather', true);
...
const Sport = new SPORT('Miata-RF', 'GT', 'Manual', 'Hard-Top', 'Red', 'Leather', 'Premium', 'Premium');
